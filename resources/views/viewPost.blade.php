                                                ...
                                                <div class="post--item">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="post--info">
                                                                <ul class="nav meta">
                                                                    <li><span>{{ $viewPosts_category[$i]->author->name }}</a>
                                                                    </li>
                                                                    <li><span>{{ $viewPosts_category[$i]->created_at->locale('vi')->diffForHumans() }}</span>
                                                                    </li>
                                                                    <li><a href="#"><i
                                                                                class="fa fm fa-eye"></i>{{ $viewPosts_category[$i]->views }}</span>
                                                                    </li>
                                                                    <li><a
                                                                            href="{{ route('posts.show', $viewPosts_category[$i]) }}"><i
                                                                                class="fa fm fa-comments"></i>{{ count($viewPosts_category[$i]->comments) }}</a>
                                                                    </li>
                                                                </ul>
                                                                ...
                                                                <div class="title">
                                                                    <h2 class="h3" style="color:black"><a
                                                                            ...
                                                                            class="btn-link">{{ $viewPosts_category[$i]->title }}</a>
                                                                        </h3>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="post--action">
                                                                <a class="btn btn-link"
                                                                    href="{{ route('posts.show', $viewPosts_category[$i]) }}">Đọc
                                                                    thêm</a>
                                                            </div>
                                                        </div>
                                                    </div>
