                            ...
                            <div class="col-md-6">
                                <div class="row gutter--15">
                                    ...
                                    @for ($i = 0; $i <= 1; $i++)
                                        ...
                                        @else
                                            <!-- You can display a message or a placeholder here if needed -->
                                            <div class="col-xs-6 col-xss-12">
                                            ...
                                            <div class="post--item post--layout-1 post--title-larger">
                                                <div class="post--img">
                                                    ...
                                                    <div class="post--info">
                                                        <ul class="nav meta">
                                                            <li><a
                                                                    href="javascript:;">{{ $posts_new[2][0]->author->name }}</a>
                                                            </li>
                                                            <li><a
                                        ...
                                        <div class="post--info">
                                            ...
                                            <div class="title">
                                                <h2 class="h4"><a href="{{ route('posts.show', $posts_new[3][0]) }}"
                                                        class="btn-link">{{ $posts_new[3][0]->title }}</a></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 ptop--30 pbottom--30">
                            ...
                            <div class="post--items-title" data-ajax="tab">
                                @if (isset($category_home[0]))
                                    <h2 class="h4">{{ $category_home[0]->name }}</h2>
                                @else
                                    <h2 class="h4">Danh mục không tồn tại</h2>
                                @endif
                            </div>
                            ...
                            <div class="post--items post--items-2" data-ajax-content="outer">
                                <ul class="nav row gutter--15" data-ajax-content="inner">
                                            ...
                                            <div class="post--img">
                                                @if (isset($post_category_home0[0]))
                                                    <a href="{{ route('posts.show', $post_category_home0[0]) }}"
                                                        class="thumb">
                                                        <img src="{{ asset($post_category_home0[0]->image ? 'storage/' . $post_category_home0[0]->image->path : 'storage/placeholders/placeholder-image.png') }}"
                                                            alt="">
                                                    </a>
                                                    <a href="javascript:;" class="icon"><i class="fa fa-flash"></i></a>
                                                    <div class="post--info">
                                    ...
                                    @for ($i = 1; $i <= 4; $i++)
                                        ...
                                        <li class="col-xs-6">
                                            <!-- Post Item Start -->
                                            @foreach ($post_category_home0 as $post)
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        <a href="{{ route('posts.show', $post) }}" class="thumb">
                                                            <img src="{{ asset($post->image ? 'storage/' . $post->image->path : 'storage/placeholders/placeholder-image.png') }}"
                                                                alt="">
                                                        </a>

                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="javascript:;">{{ $post->author->name }}</a>
                                                                </li>
                                                                <li><a
                                                                        href="javascript:;">{{ $post->created_at->locale('vi')->diffForHumans() }}</a>
                                                                </li>
                                                            </ul>
